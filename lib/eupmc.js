...
EuPmc.prototype.pageQuery = function() {
  ...
  var retryOnHTTPNetOrEuPMCFailure = function (err, resp, body){
    console.log('retryer')
    return requestretry.RetryStrategies.HTTPOrNetworkError(err, resp, body) ||
    (!resp.hitCount || !resp.hitCount[0] || !resp.resultList[0].result)
  }
